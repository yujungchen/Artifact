...
int main(int argc, char **argv){
	...
	if(argc == 2){
		if(strcmp(argv[1], "configure.txt") != 0){
			...
			printf("[Usage] ./Artifact [Model] [ImageWidth] [SampleNumber] [FocusDistance*10]\n\n");
			return 0;
		}
		else
		...
		if(argc < 5){
	    	printf("\n[Usage]: ./Artifact [Model] [ImageWidth] [SampleNumber] [FocusDistance*10]\n\n");
	    	return 0;
		}
		else
	...
	// Configure Camera
	Camera *cam = new Camera(m_CameraPos, m_CameraLookat,
							 m_Fstop, m_FocalLength, m_Aperture, 
